...
Concrete I/O. The only place HTTP happens in this service. Retry policy
matches stats-loader / ``docs/references/sleeper-api.md``:
...
class HttpClient(Protocol):
    """Protocol the core layer accepts. Keeps ``core`` testable without httpx."""
